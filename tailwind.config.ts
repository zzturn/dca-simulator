  ...
  theme: {
    extend: {
      colors: {
        ...
        // 热力图颜色阶梯 - 盈利（红）：从浅到深，高级感配色
        "profit-1": "#F87171", // +0~2% 透亮珊瑚红（确保低数值可见）
        "profit-2": "#EF4444", // +2~5% 标准金融红
        "profit-3": "#B91C1C", // +5%+ 稳重深红
        // 热力图颜色阶梯 - 亏损（绿）：从浅到深，高级感配色
        "loss-1": "#4ADE80", // -0~2% 晶莹薄荷绿（确保低数值可见）
        "loss-2": "#22C55E", // -2~5% 标准金融绿
        "loss-3": "#15803D", // -5%+ 深邃森林绿
        // 文字层级
        "on-surface": "#f1f5f9",
